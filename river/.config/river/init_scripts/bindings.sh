...
mod="Mod4"
altmenu="~/.config/river.local/scripts/wofi_csv"
...
# App Bindings
#riverctl map normal $mod Z spawn "MESA_LOADER_DRIVER_OVERRIDE=i965 qutebrowser"
#riverctl map normal $mod Z spawn "luakit"
#riverctl map normal $mod W spawn "luakit web.whatsapp.com"
riverctl map normal $mod Z spawn "qutebrowser"
riverctl map normal $mod W spawn "qutebrowser web.whatsapp.com"

riverctl map normal $mod+Mod1 C spawn 'clipman pick -t wofi'
riverctl map normal $mod X spawn "$term -e ~/.local/scripts/lf-tmux"
...
#riverctl map normal $mod O spawn ~/.local/scripts/screenOnOff.sh
...
# launcher
#riverctl map normal $mod D spawn "wofi -I --show drun --prompt=Applications --height=750 --width=600 --term=$tem"
riverctl map normal $mod D spawn 'fuzzel -b 111111ff -t eceff4ff -s 5e81acff -S eceff4ff -f hack --line-height=16 -x 20 -B 5 -r 20'
#riverctl map normal $mod D spawn 'j4-dmenu-desktop --dmenu="fuzzel -d -i breeze -b 000000bb -t ffffffff -s efcc00ff -S 000000ff -f hack"'
...
# main factor/count
riverctl map normal $mod+Mod1 Left send-layout-cmd stacktile 'main-ratio -0.05'
riverctl map normal $mod+Mod1 Right send-layout-cmd stacktile 'main-ratio +0.05'
riverctl map normal $mod+Mod1 Up send-layout-cmd stacktile 'main-count +1'
riverctl map normal $mod+Mod1 Down send-layout-cmd stacktile 'main-count -1'
...
riverctl float-filter-add app-id "whatsapp"
